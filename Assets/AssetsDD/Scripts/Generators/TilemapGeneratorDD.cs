...
public class TilemapGeneratorDD : NetworkBehaviour
{
    ...
    public GameObject startingTilemap;
    private GameObject[,] spawnedTilemaps;
    
    void Start()
    {
        spawnedTilemaps = new GameObject[1000, 1000];
    ...
    private void CheckAndSpawnTilemapsAround()
    {
        ...
        {
            GameObject newTilemap = Instantiate(tilemapPrefabs[Random.Range(0, tilemapPrefabs.Length)]);
