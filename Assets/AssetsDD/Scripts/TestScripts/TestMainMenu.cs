...
public class TestMainMenu : NetworkBehaviour
{
    ...
    private void Update()
    {
        if(!inGame)
        {
            TestPlayer[] players = FindObjectsOfType<TestPlayer>();
    ...
    public void Host()
    {
        ...
        TestPlayer.localPlayer.HostGame();
    }
    ...
    public void HostSuccess(bool success, string matchID)
    {
        if(success)
        {
            ...
            SpawnPlayerUIPrefab(TestPlayer.localPlayer);
            IDText.text = matchID;
    ...
    public void Join()
    {
        ...
        TestPlayer.localPlayer.JoinGame(JoinInput.text.ToUpper());
    }
    ...
    public void SpawnPlayerUIPrefab(TestPlayer player)
    {
    ...
    {
        TestPlayer.localPlayer.BeginGame();
    }
    ...
    public void BeginGame(string matchID)
    {
        ...
        for(int i = 0; i < matches.Count; i++)
        {
            if(matches[i].ID == matchID)
            {
                ...
                {
                    TestPlayer player1 = player.GetComponent<TestPlayer>();
